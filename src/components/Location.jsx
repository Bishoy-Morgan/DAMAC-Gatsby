...
export default function Location() {
    return (
        <section className='w-full h-[1300px] md:h-[850px] 2xl:h-[1150px] pt-5 md:pt-0 flex flex-col justify-between md:justify-evenly items-center md:-translate-y-20 pb-8 '>
            <div className='w-[90%] max-w-[1920px] md:w-3/5 h-[18%] flex flex-col justify-evenly items-center '>
                <h4 className='font-["Oswald"] text-[#004572] text-4xl font-medium uppercase  '>location</h4>
                <p className='leading-[24px] text-[#343434] text-center max-w-[780px] mx-auto '>Strategically located between Port Rashid and Dubai’s Drydocks World, Dubai Maritime City capitalises on its strengths, bringing together the entire maritime industry and offering residents a dynamic, urban lifestyle. KNOW MORE</p>
            </div>
            <div className='w-[90%] max-w-[1920px] md:w-4/5 h-1/5 md:h-[52%] rounded-[14px]'>
                <iframe 
            ...
            <div className='w-[90%] max-w-[1920px] md:w-4/5 h-[55%] md:h-1/4 lg:h-1/5 p-3 rounded-[14px] bg-[#00357B] flex flex-col md:flex-row justify-evenly items-center'>
                ...
                <div className='w-[90%] max-w-[1920px] md:w-[24%] h-[23%] md:h-full bg-[#5790BE]/20 rounded-[14px] flex flex-col justify-center items-center '>
                    <StaticImage 
